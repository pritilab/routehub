...
> Пометка [v] = подтверждено проверкой официального источника (июль 2026);
> [~] = из практических руководств или не подтверждено при проверке —
> перепроверить под вашу ситуацию.

---

## 1. Правовой статус: что уже можно

- [v] Временная защита ЕС продлена **до 04.03.2027** (решение Совета ЕС
  2025/1460 от 15.07.2025); действующие ВНЖ по §24 продлеваются автоматически,
  заявление не требуется (BMI).
- [~] ВНЖ по §24 с отметкой **«Erwerbstätigkeit erlaubt»** разрешает
  **самозанятость и предпринимательство без отдельного разрешения по §21**:
  Gewerbeanmeldung, freiberufliche Tätigkeit, учреждение UG/GmbH (IHK-руко-
  водства; первоисточник при повторной проверке был недоступен — подтвердить
  лично в IHK Ostwestfalen или ABH до регистрации).
...
- [v] **Einstiegsgeld** (§16b SGB II): добровольная доплата Jobcenter при
  выходе из Bürgergeld в самозанятость — как правило **50% от Regelbedarf**
  (≈€280/мес для одинокого получателя, зависит от состава домохозяйства),
  до 24 мес., по усмотрению кейс-менеджера; подавать **до** начала
  деятельности, с бизнес-планом (этот пакет документов подходит как основа).
...
| --- | --- | --- |
| **Einstiegsgeld** (Jobcenter Minden-Lübbecke) | ≈50% Regelbedarf (~€280/мес) ≤24 мес. | [v] дискреционно; подать до старта; нужен бизнес-план |
| **Gründungsstipendium.NRW** | **€1 200/мес × 12 мес.** | [v] суммы и соло-допуск подтверждены; заявка через аккредитованную сеть. [~] Формулировка требования к ВНЖ для не-ЕС на офстраницах не зафиксирована — уточнить у сети/NRW.BANK; с §24 (до 03.2027) окно для 12-месячного гранта сужается: **подавать как можно раньше** |
| **EXIST-Gründungsstipendium** (федеральный) | €2 500/мес + до €10 тыс. Sachmittel + €5 тыс. коучинг, 12 мес. | [v] суммы подтверждены; требует привязки к вузу (диплом <5 лет или зачисление) — реалистично через Uni Bielefeld / Uni Paderborn (garage33). [~] Допуск граждан третьих стран явно не прописан на офстранице — уточнить у Gründungsservice вуза |
